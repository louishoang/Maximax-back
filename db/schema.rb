...
ActiveRecord::Schema.define(version: 2018_06_28_023155) do
  ...
  create_table "option_values", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name", "display_name"], name: "index_option_values_on_name_and_display_name"
  ...
  create_table "product_properties", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id", "property_id"], name: "index_product_properties_on_product_id_and_property_id"
  end
